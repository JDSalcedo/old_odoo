...
class amount_to_text:
    ...
    def amount_to_text_cheque(self, nNumero, intermedio="pesos ", sufijo="M. N."):
        ...
        @conector : Sufix of the currency
        ...
        strCantDecimal += "/100"
        return strCantEntera+' '+conectordecimal+' '+strCantDecimal+' '+sufijo
...
def get_amount_to_text(self, amount, lang, currency=""):
    ...
    """
    if currency.upper() in ('PEN'):
        sufijo = 'NUEVOS SOLES'
    elif currency.upper() in ('USD'):
        sufijo = 'DOLARES AMERICANOS'
...
if __name__ == "__main__":
    ...
    """
    letra = amount_to_text().amount_to_text(1500)
    #letra = amount_to_text().amount_to_text_cheque(1500.25, 'pesos', 'M. N.')
    #letra = amount_to_text().amount_to_text(1500.25, False)
    print letra.upper()
